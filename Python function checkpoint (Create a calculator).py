...
It will prompt the user to input two numbers and an arithmetic operator, then perform the corresponding operation on the numbers and return the result.
...
You may want to use a "while" loop to allow the user to roll the dice multiple times, or to add 
...
def calculator(first_num, second_num):
    operation= input("pick an arithmetic operation(+,-,*,/):")
    if operation =="+":
        ...
        return "Please only use the symbol above"
